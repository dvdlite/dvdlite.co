...
layout: page
---
{% eleventyImage "./src/assets/images/caliper.jpg","Starrett inside calipers on a black walnut slab, photo by David Leitko" %}
...
Here are all the obligatory IndieWeb [slash pages](https://slashpages.net):
...
* [/changelog](/changelog) - Changes to this website (redirects to github commits)
...
* Anti-library (maybe?) - Unread books on my shelf
